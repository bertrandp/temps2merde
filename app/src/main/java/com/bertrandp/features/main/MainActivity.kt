...
import com.bertrandp.R
import com.bertrandp.features.base.BaseActivity
import com.bertrandp.features.common.ErrorView
...
class MainActivity : BaseActivity(), MainMvpView, PokemonAdapter.ClickListener, ErrorView.ErrorListener {
    ...
    @BindView(R.id.layout_forecast) @JvmField var mForecastLayout: LinearLayout? = null
    @BindView(R.id.message) @JvmField var mMessage: TextView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSwipeRefreshLayout?.setOnRefreshListener { mMainPresenter.getData(POKEMON_COUNT) }
        ...
        mMainPresenter.getData(POKEMON_COUNT)
    }
    ...
    override fun showForecast(rainForecast: RainForecast) {
        // TODO("not implemented") //To change body of created functions use File | Settings | File Templates.

        mMessage?.text = rainForecast.rainLevelLabel?.get(0)
